...
class ControllerDS {
  async init() {
    const connectionString = process.env.connectionString || 'postgres://sb_bs:d3JwzHP8EXqVTpNPpPAV@back-scratchers.czbbmrowa8yc.us-east-2.rds.amazonaws.com:5432/backscratchers'
